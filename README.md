...
Along the way the character grows by leveling up and learning talents with active skills, completes quests for merchants, buys and equips gear (helmets, armor, robes, cloaks), and progress is saved locally in the browser.
